...
site/                 Diretrizes do futuro carrochefe.com
docs/                 Arquitetura e plano do negócio
planejamento/         Central Operacional, API e dados iniciais
```
...
- API de requisições com aprovação, trilha de auditoria e upload de evidências;
- painel responsivo baseado na identidade visual existente.
