...
O manual operacional está em `tools/excel_recipe/README.md`. O procedimento para agentes está em `docs/EXCEL_RECIPE_AGENT_GUIDE.md`. A próxima entrega está definida em `docs/EXCEL_RECIPE_V2_PLAN.md`.
