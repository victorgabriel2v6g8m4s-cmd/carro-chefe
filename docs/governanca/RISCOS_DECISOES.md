...
| `DEC-012` | 17/09/2026 | Substituir **Carro‑Chefe com Cheddar** por **Carro‑Chefe Brasa Dourada** | aprovação direta do proprietário; mantém `PROD-CCC-001` para rastreabilidade e redefine o conceito como baguete de 15 cm com um espeto, cheddar, cebola-roxa tostada na parrilla, barbecue e batata palha, sujeito a ficha técnica/gramaturas finais |
...
| `RISK-008` | inconsistência de marca e grafia | 4 | 3 | glossário, aprovação e manual de marca; novas peças usam Brasa Dourada no lugar de “com Cheddar” |
