...
export async function planRoutes(app: FastifyInstance) {
  ...
  app.get("/api/v1", async () => ({ version: "v1", documentation: "/api/v1/openapi.yaml", health: "/api/health", bootstrap: "/api/v1/bootstrap", intents: "/api/v1/intents", managementConversations: "/api/v1/management-conversations", knowledge: "/api/v1/knowledge/nodes", references: "/api/v1/references", notifications: "/api/v1/notifications", tasks: "/api/v1/tasks", runs: "/api/v1/agent-runs", questions: "/api/v1/agent-questions", uploads: "/api/v1/uploads", events: "/api/v1/events" }));
