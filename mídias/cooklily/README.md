...
Três arquivos tiveram bytes, dimensões e SHA-256 conferidos nesta incorporação. As duas fotos de produto foram reenviadas com nomes únicos em 23/09/2026 e tiveram dimensões, tamanho e SHA-256 verificados.
...
- **Marca:** a logo recebida contém o lettering `cookLily`, enquanto o nome público aprovado no projeto é **CookLily**. O original é preservado; a reconciliação do nome deve ser decidida no kit de marca antes de adaptar o lettering.
...
| --- | --- | --- | --- | ---: | ---: | --- | --- |
| `CL-MARCA-001` | `originais/marca/2026-09-23_marca-lily-gourmet-logo-principal_png_v01_review.png` | `cook (6).png` | Logo circular rosa com laço e lettering `cookLily` | 2048×2048 | 384.801 B | `70448b75e51a603540d6610fb004c0902ac011819cd5a6ff5a813246471ee92c` | `review` |
| `CL-IMP-001` | `originais/impressos/2026-09-23_marca-lily-gourmet-adesivo-500ml-qr_png_v01_review.png` | `500ml (4 x 8 cm) (7).png` | Arte vertical de adesivo com logo, mensagem, QR e CTA | 1024×2048 | 2.885.636 B | `7b480878a429aad9a4e0299e9a2fc3651eea84264272bb2d7fd9ccd48387ad14` | `review` |
| `CL-PROD-001` | `originais/produtos/2026-09-23_produto-batida-acai-maracuja_foto_v01_review.jpeg` | `imagem_editada_acai_com_maracuja.jpeg` | Garrafa de batida roxa com creme/mousse amarelo | 900×1600 | 111.657 B | `e64cec799074320a91b734b9b21fd9850e178aded0acd9575a37ef1d3957f74d` | `review` |
| `CL-PROD-002` | `originais/produtos/2026-09-23_produto-batida-acai-morango_foto_v01_review.jpeg` | `imagem_editada_acai_com_maracuja.jpeg` | Garrafa de batida roxa com creme/mousse rosa | pendente | pendente | pendente de reenvio | `review/pending_binary` |
...
A arte do adesivo reforça a família rosa/roxa, mas é uma peça anterior à consolidação de **CookLily** e usa o logo `cookLily`. O QR foi decodificado para:
